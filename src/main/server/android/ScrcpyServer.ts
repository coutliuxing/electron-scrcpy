...
const FILE_DIR = path.join(process.env.NODE_ENV === 'development'?path.resolve("")/*项目目录*/:process.resourcesPath, 'vendor/Genymobile/scrcpy');
...
export class ScrcpyServer {
    ...
    public static async run(device: Device): Promise<number[] | undefined> {
        ...
        console.log("scrcpy command",RUN_COMMAND)
